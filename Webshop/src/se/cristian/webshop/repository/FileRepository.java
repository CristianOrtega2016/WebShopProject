...
import se.cristian.webshop.idgenerator.Identifiable;
import se.cristian.webshop.repository.file.ECommerceFileInfo;
import se.cristian.webshop.repository.file.FileManager;

public class FileRepository <T extends Identifiable<String>> implements Repository<String, T>
{
