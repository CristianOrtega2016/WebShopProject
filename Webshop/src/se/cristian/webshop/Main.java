package se.cristian.webshop;

import se.cristian.webshop.exception.CustomerRegistrationException;
import se.cristian.webshop.exception.OrderException;
import se.cristian.webshop.exception.PaymentException;
import se.cristian.webshop.exception.ProductRegistrationException;
import se.cristian.webshop.exception.RepositoryException;
import se.cristian.webshop.idgenerator.ECommerceIdGenerator;
import se.cristian.webshop.idgenerator.IdGenerator;
import se.cristian.webshop.model.Customer;
import se.cristian.webshop.model.Order;
import se.cristian.webshop.model.Product;
import se.cristian.webshop.model.ShoppingCart;
import se.cristian.webshop.repository.FileRepository;
import se.cristian.webshop.repository.Repository;
import se.cristian.webshop.service.ECommerceService;
import se.cristian.webshop.service.validation.CustomerValidator;
import se.cristian.webshop.service.validation.DuplicateValidator;
import se.cristian.webshop.service.validation.EmailValidator;
import se.cristian.webshop.service.validation.PasswordValidator;
import se.cristian.webshop.service.validation.ProductValidator;


public class Main
{

	public static void main(String[] args) throws CustomerRegistrationException, ProductRegistrationException, RepositoryException, OrderException, PaymentException
	{
